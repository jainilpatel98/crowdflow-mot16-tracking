...
def find_full_report_runs() -> list[tuple[Path, dict[str, Any], dict[str, Any]]]:
    runs_root = PROJECT_ROOT / "tracking_eval" / "runs"
...
def main() -> int:
    ...
    checks = [
        ...
        ("single_frame_model_integration", lambda: check_single_frame_model_integration(streamlit_module)),
        ("sequence_tracker_smoke", lambda: check_sequence_tracker_smoke(tracking_eval_module, run_dir)),
        ...
        ("streamlit_live_helper_smoke", lambda: check_streamlit_live_helper_smoke(streamlit_module, run_dir)),
